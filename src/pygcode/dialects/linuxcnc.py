...
# CHANGES JJL2 2020-03-18:
# - changed CLEAN_FLOAT from :g to :6f
# - changed CLEAN_FLOAT rounding to 7 decimal places.
...
CLEAN_FLOAT = lambda v: "{0:6f}".format(round(v, 7))
CLEAN_CODE = _clean_codestr
CLEAN_INT = lambda v: "%g" % v
# END CHANGES JJL2 2020-03-18
